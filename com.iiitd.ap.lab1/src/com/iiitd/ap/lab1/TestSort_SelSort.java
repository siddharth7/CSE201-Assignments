...
//Sort Test Cases for Selection Sort
@RunWith(Enclosed.class)
public class TestSort_SelSort
{
...
public static class TestSort_Int {
	...
	@Test
	public void selsort_int()
	{//For array of integers
		
		Integer[] abc=selectsort.Sort(intlist);
...
public static class TestSort_String {
	...
	@Test
	public void selsort_srt()
	{//For array of string
		
		String[] abc=selectsort.Sort(strlist);
...
public static class TestSort_Double {
	...
	@Test
	public void selsort_db()
	{//For array of double
		
		Double[] abc=selectsort.Sort(dblist);
