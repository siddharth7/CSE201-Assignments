 ...
 */
@WebServlet("/updateOrderPage2")
public class updateOrderPage2 extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public updateOrderPage2() {
        super();
	...
	//			    		s.replaceAll(final1,finals);
		...
		log2.renameTo(ff);
		RequestDispatcher rd = request.getRequestDispatcher("currentOrders2.jsp");
